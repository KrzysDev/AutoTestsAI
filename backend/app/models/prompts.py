import json
from backend.app.models.schemas import AgenticPromptFirstLayer, RetrivedChunk, TransformedPrompt
...
class SystemPrompts:
    ...
    def get_first_layer_prompt(self, transformed_prompt: TransformedPrompt, retrived_chunks: list[RetrivedChunk], teacher_request: str) -> AgenticPromptFirstLayer:
       structure = {
